...
function Instafeed(e) {
  ...
  assert(
    ...
    assert(
      !t.apiLimit || "number" == typeof t.apiLimit,
...
(Instafeed.prototype.run = function () {
  ...
  (Instafeed.prototype._showNext = function (e) {
    var t = this,
      o = null,
      n = null,
      ...
      t._state.paging && "string" == typeof t._state.paging.next
        ...
        t._makeApiRequest(o, function (o, n) {
          ...
          try {
            if (
              ((s = t._processData(n)),
              t._debug("onResponseReceived", "processed data", s),
              s.unused && s.unused.length > 0)
            ) {
              t._debug(
                "onResponseReceived",
              ...
              for (var r = 0; r < s.unused.length; r++)
                t._state.pool.push(s.unused[r]);
            }
          } catch (a) {
            return void e(a);
          }
  ...
  (Instafeed.prototype._processData = function (e) {
    ...
    return (
      s &&
        ((r = i.length - this._options.limit),
        this._debug(
          "processData",
          "checking limit",
          i.length,
        ...
        r > 0 &&
          ((p = i.slice(i.length - r)),
          this._debug("processData", "unusedItems", p.length, p),
          i.splice(i.length - r, r))),
      { items: i, unused: p }
    );
  }),
  (Instafeed.prototype._extractTags = function (e) {
    var t = /#([^\s]+)/gi,
      o = /[~`!@#$%^&*\(\)\-\+={}\[\]:;"'<>\?,\./|\\\s]+/i,
      n = [],
      s = null;
    if ("string" == typeof e)
      for (; null !== (s = t.exec(e)); ) !1 === o.test(s[1]) && n.push(s[1]);
    return n;
  }),
  (Instafeed.prototype._getItemData = function (e) {
    var t = null,
      o = null;
    switch (e.media_type) {
      case "IMAGE":
  ...
  (Instafeed.prototype._renderData = function (e) {
    ...
    if (
      ...
      for (
        ...
        this._debug("renderData", "appending child", i.childNodes[0]),
          this._state.node.appendChild(i.childNodes[0]);
    }
  }),
  (Instafeed.prototype._basicRender = function (e) {
    for (
      var t = new RegExp(
      ...
      (r = n[1]),
        (s += o.slice(i, n.index)),
        (a = this._valueForKeyPath(r, e)) && (s += a.toString()),
        (i = t.lastIndex);
    return i < o.length && (s += o.slice(i, o.length)), s;
  }),
  (Instafeed.prototype._valueForKeyPath = function (e, t) {
    for (var o = /([\w]+)/gm, n = null, s = t; null !== (n = o.exec(e)); ) {
      if ("object" != typeof s) return null;
      s = s[n[1]];
    }
    return s;
  }),
  (Instafeed.prototype._fail = function (e) {
  ...
  (Instafeed.prototype._start = function () {
    (this._state.running = !0), this._runHook("before");
  }),
  (Instafeed.prototype._finish = function () {
    this._runHook("after"), (this._state.running = !1);
  }),
  (Instafeed.prototype._success = function (e) {
    this._runHook("success", e), (this._state.running = !1);
  }),
  (Instafeed.prototype._makeApiRequest = function (e, t) {
    var o = !1,
      n = this,
      s = null,
      i = function (e, n) {
    ...
    ((s = new XMLHttpRequest()).ontimeout = function () {
  ...
  (Instafeed.prototype._getAccessToken = function (e) {
    var t = !1,
      o = this,
      n = null,
      s = function (o, s) {
        t || ((t = !0), clearTimeout(n), e(o, s));
      };
  ...
  (Instafeed.prototype._debug = function () {
    var e = null;
    this._options.debug &&
      console &&
  ...
  (Instafeed.prototype._runHook = function (e, t) {
    var o = !1;
